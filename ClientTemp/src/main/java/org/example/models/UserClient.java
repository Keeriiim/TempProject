...
public class UserClient {
    ...
    public void run(String token) throws IOException, InterruptedException {
        ...
        while(program_is_running) {
            ...
            System.out.println("4. Uppdatera en användares behörigheter");
            System.out.println("5. Ta bort en användares roll");
            ...
            switch (choice){
                ...
                case "4":
                    System.out.print("AnvändarID: ");
                    //updateUserRole(authToken, String updateId);
                    break;
                case "5":
                    System.out.print("AnvändarID: ");
                    //removeRole(authToken, String removeId);
                    break;
                case "6":
